...
# reference channels
refchans = np.array([36, 75, 112, 151, 188, 227, 264, 303, 340, 379])
connected = ~np.isin(channel_map, refchans)

# physical location of each channel on the probe
xcoords = np.tile([43, 11, 59, 27], NCHANS//4)  # 43 11 59 27 43 11 59 27 ...
ycoords = 20 * np.repeat(1 + np.arange(NCHANS//2), 2)  # 20 20 40 40 ... 3820 3820 3840 3840
